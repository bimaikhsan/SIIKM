                      ...
                      <div class="col-sm-12 text-sm-left">
						...
						<div class="mb-3">
                          <label class="form-label" for="basic-icon-default-fullname">Nama Lengkap</label>
                            <span class="input-group-text"><i class="bx bx-user px-0 me-xl-4"></i><?=$_SESSION['USER']['nama']?></span>
                        </div>
						<div class="mb-3">
                          <label class="form-label" for="basic-icon-default-fullname">Email</label>
                            <span class="input-group-text"><i class="bx bx-envelope px-0 me-xl-4"></i><?=$_SESSION['USER']['email']?></span>
                        </div>
						<div class="mb-3">
                          <label class="form-label" for="basic-icon-default-fullname">Tanggal Lahir</label>
                            <span class="input-group-text"><i class="bx bx-calendar px-0 me-xl-4"></i><?=$_SESSION['USER']['tanggal_lahir']?></span>
                        </div>
                        </div>
                      </div>
                    </div>
