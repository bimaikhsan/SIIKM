      ...
      <div class="layout-container">
        ...
        <nav
          ...
          <div class="content-wrapper">
			...
			<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Informasi /</span> <?=$_GET['data']?></h4>
			  ...
			  <?php 
				...
				<div class="card">
                    <div class="d-flex align-items-up row">
                      <div class="col-sm-5">
                        <div class="card-body text-center ">
						<img
                            src="./assets/gambar/<?=$isi['image']?>"
                            width="240"
                            alt="View Badge User"
                      ...
                      <div class="col-sm-7 text-sm-left">
                        <div class="card-body">
						 <p class="mb-4">
						  ...
						  <?php if (!empty($isi['link_daftar'])) { ?>
							<a href="<?=$isi['link_daftar']?>" class="btn btn-sm btn-primary">Link Pendaftaran</a>
						  <?php } ?>
						  <?php if (!empty($isi['link_halaman'])) { ?>
	                        <a href="<?=$isi['link_halaman']?>" class="btn btn-sm btn-primary">Lihat Selengkapnya</a>
						  <?php } ?>
