          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="./index.php?page=home" class="app-brand-link gap-2">
                  <span class="app-brand-text demo text-body fw-bolder">SIIKM</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Selamat Datang, Mahasiswa 👋</h4>
              <p class="mb-4">Di Sistem Informasi Mahasiswa, Silahkan Login Terlebih dahulu!</p>
              ...
              <p class="text-center">
                <span>Buat baru akun mahasiswa ?</span>
...
if(isset($_POST['submit'])){
    ...
    $result = $fungsi->proses_login($user,$pass,'mahasiswa');
    if($result == 'gagal')
    {
