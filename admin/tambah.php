      ...
      <div class="layout-container">
        ...
        <nav
          ...
          <div class="content-wrapper">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page / Data Informasi / </span>Tambah Data Informasi</h4>
            <div class="card">
            <div class="col-md-12">
                  <div class="card mb-4">
                    <div class="card-body">
                    <form method="POST" action="" enctype='multipart/form-data'>
                      <div class="mb-3">
                        ...
                        <input class="form-control" name="gambar" type="file" id="formFile" accept="image/*" required />
                      </div>
                      <div class="mb-3">
...
if(isset($_POST['submit'])){
    ...
    if(in_array($file_extension, $valid_extension)) {
        if(move_uploaded_file(
            ...
            echo '<script>alert("Tambah Data Informasi Berhasil");window.location="./index.php?page=datainformasi"</script>';
        }
    }
}
?>