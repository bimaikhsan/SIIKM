            ...
            <div class="card">
                <div class="col-lg-12 mb-4 order-0">
                    <div class="card">
                        ...
                        <div class="col-sm-9">
                            <h5 class="card-header">Tabel data kategori</h5>
                        </div>
                        <div class="col-sm-3 text-center">
                            <a class="btn pb-4 px-4 px-md-0" href="./index.php?page=tambah_kategori"><i class="bx bx-plus me-1"></i> Tambah</a>
                        </div>
                        </div>
                    </div>
                </div>
                  ...
                  <table class="table">
                    ...
                    ?>
                      <tr>
                        <td><?=$val['nama']?></td>
                        <td>
                            <a class="btn" href="./edit_kategori.php?id=<?php echo $val['id'];?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>

                            <a class="btn" onclick="return confirm('Apakah yakin data akan di hapus?')" href="./hapus_kategori.php?hapusid=<?php echo $val['id'];?>" ><i class="bx bx-trash me-1"></i> Delete</a>
                        </td>
                      </tr>
                    <?php
                        }
