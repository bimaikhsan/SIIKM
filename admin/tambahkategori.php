      ...
      <div class="layout-container">
        ...
        <nav
          ...
          <div class="content-wrapper">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page / Data Kategori / </span>Tambah Data Kategori</h4>
            <div class="card">
            <div class="col-md-12">
                  <div class="card mb-4">
                    <div class="card-body">
...
if(isset($_POST['submit'])){
    ...
    echo '<script>alert("Tambah Data Kategori Berhasil");window.location="./index.php?page=datakategori"</script>';
}
?>