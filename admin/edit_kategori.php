<?php
    ...
    $hasil = $fungsi->tampil_data_id('kategori','id',$idGet);
?>
<!DOCTYPE html>
<html
  lang="en"
      ...
      <div class="layout-container">
        ...
        <nav
          ...
          <div class="content-wrapper">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page / Data Kategori / </span>Edit Data Kategori</h4>
            <div class="card">
            <div class="col-md-12">
                  <div class="card mb-4">
                    <div class="card-body">
                    <form method="POST">
                      ...
                      <div class="mb-3">
                        ...
                        <input
                          ...
                          placeholder="Entri Nama Kategori"
                        />
                      </div>
...
if(isset($_POST['submit'])){
    ...
    echo '<script>alert("Edit Data Kategori Berhasil");window.location="./index.php?page=datakategori"</script>';
}
?>